...
class ReflectionUtil
{
    ...
    public static function getPropertyClass($class, $propertyName)
    {
        ...
        if (isset($param)) {
            ...
            throw new AlderConfigurationException("Getter function for '$propertyName' in '$class' class should have a proper return type.");
        }
    }
